		...
		<fieldset>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<html:radio property="agncgtp" styleId="clncgtp1" value="1" onclick="ajustaTipoPessoa(this)">Pessoa Física</html:radio>&nbsp;&nbsp;
						<html:radio property="agncgtp" styleId="clncgtp2" value="2" onclick="ajustaTipoPessoa(this)">Pessoa Jurídica</html:radio>
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<html:text property="agccnpj" size="15" maxlength="14"></html:text>
					</td>
				</tr>
				<tr>
					<th>
